...
<body>
 ...
 $cat = $_GET['cat'];
        ...
        $consulta = $cn->query("select nm_skate,vl_preco,ds_capa,qt_estoque from vw_skate  where ds_categoria = '$cat'");
    ?>
...
<?php
   while ($exibe = $consulta->fetch(PDO::FETCH_ASSOC))  { ?>
    ...
    <img src="imagens/<?php echo $exibe ['ds_capa']; ?>.JPG" class="img-responsive" style="width:100%">
        <div><h4><b><?php echo mb_strimwidth($exibe['nm_skate'],0,30,'...'); ?></b></h4></div>
             <div><h4 style ="color #f5be01"> R$<?php echo number_format($exibe['vl_preco'],2,',','.'); ?></h4></div>
			 
			 
   
            <div class="text-center">
			  <button class="btn btn-lg btn-block btn-dafault">
